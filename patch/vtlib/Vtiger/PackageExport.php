...
//			try {
				...
				if($uitype == '15' || $uitype == '16' || $uitype == '111' || $uitype == '33' || ($uitype == '55' && ($fieldname == 'salutationtype' || $fieldname == 'countrydial'))) {

					if($uitype == '16' || $uitype == '55') {
...
//			} catch (Exception $e) {
//				throw new Exception('Field index: ' . json_encode($info_schemarow));
//			}
